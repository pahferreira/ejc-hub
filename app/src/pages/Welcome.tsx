...
export function Welcome() {
  ...
  return (
    <div className="bg-welcome-gradient">
      <main className="flex flex-col gap-3 md:gap-6 justify-center min-h-screen p-8 max-w-[1280px] mx-auto">
        <section>
          <h1 className="uppercase font-bold text-4xl">Bem vindo ao</h1>
          <h2 className="uppercase font-serif font-bold text-3xl text-blue-500">Ponto EJC</h2>
        </section>
